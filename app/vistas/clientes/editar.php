    ...
    <div class="col-md-8 mx-auto">
        <div class="card card-glass-modern border-0 mt-4 mb-5">
            <div class="card-header bg-dark text-white border-0 py-3">
                <h4 class="mb-0 fw-bold"><i class="fas fa-user-edit text-warning me-2"></i> <?php echo htmlspecialchars($datos['titulo']); ?></h4>
            </div>
            ...
            <div class="card-body p-4 bg-body-tertiary">
                ...
                <p class="text-body-secondary mb-4 pb-2 border-bottom border-secondary border-opacity-10">
                    <i class="fas fa-info-circle text-primary me-1"></i> Modifique los campos parametrizados que requiera actualizar de la ficha técnica del abonado.
                </p>
                ...
                <form action="<?php echo RUTA_URL; ?>/clientes/editar/<?php echo $datos['id_cliente']; ?>" method="POST" novalidate>
                    ...
                    <div class="bg-body border rounded-3 p-3 mb-4 shadow-sm">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <input type="email" name="email" id="email" class="form-control bg-body border shadow-none rounded-3" value="<?php echo htmlspecialchars($datos['email']); ?>">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-body border rounded-3 p-3 mb-4 shadow-sm">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" name="referencia" id="referencia" class="form-control bg-body border shadow-none rounded-3" value="<?php echo htmlspecialchars($datos['referencia']); ?>">
                            </div>
                            <div class="col-md-12">
                    ...
                    <div class="bg-body border rounded-3 p-3 mb-4 shadow-sm">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                <label for="estado_servicio" class="form-label fw-bold text-body-emphasis small">Estado del Servicio: <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-6">
                                <label for="fecha_instalacion" class="form-label fw-bold text-body-emphasis small">Fecha de Instalación: <span class="text-danger">*</span></label>
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="detalles" id="detalles" class="form-control bg-body border shadow-none rounded-3" rows="3"><?php echo htmlspecialchars($datos['detalles'] ?? ''); ?></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-end gap-2 border-top border-secondary border-opacity-10 pt-4">
                        ...
                        <button type="submit" class="btn btn-primary fw-bold rounded-pill px-4 shadow-sm">
                            <i class="fas fa-save me-1"></i> Actualizar Datos del Cliente
                        </button>
                    </div>
                </form>
            </div>
